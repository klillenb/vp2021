<?php
	...
	if(isset($_POST["profile_submit"])){
		if(isset($_POST["bg_color_input"]) and isset($_POST["text_color_input"])){ //and !empty($_POST["description_input"])){
			$profile_store = store_new_profile($_POST["description_input"], $_POST["bg_color_input"], $_POST["text_color_input"]);
